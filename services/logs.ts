...
const MAIN_CHAIN_EVENTS = new Set([
  ...
  "download.host-noise.retry",
  "download.tls-timeout.retry",
  "download.video.command.completed",
  "download.audio.command.completed",
  "download.command.completed",
  "download.output.fallback",
  "merge.ffmpeg.completed",
  "merge.ffmpeg.transcode.completed",
  "verify.completed",
  "verify.soft.completed",
